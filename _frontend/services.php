    ...
    <!-- ====================== Top Banner ===================== -->
        <div class="top-banner">
            ...
            <div class="top-banner--content">
                <h1 class="top-banner--title">Friendly Services</h1>
                <p>
                   Please your little companion available services
                </p>
            </div>
        </div>
    <!-- ===================== FILTER & SORT ===================== -->
                    ...
                    <div class="grid-flex--no-gutter grid-flex__col--8">
                        <form action="" class="form__row form-filter--left">
                            <select name="type" class="form-select">
                                ...
                                <option value="1">Pet Care / Penitipan</option>
                                <option value="2">Training / Pelatihan</option>
